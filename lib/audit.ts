...
export const AUDIT = {
  ...
  // RCA workflows
  RCA_WORKFLOW_CREATE:   'RCA_WORKFLOW_CREATE',
  RCA_WORKFLOW_UPDATE:   'RCA_WORKFLOW_UPDATE',
  RCA_WORKFLOW_DELETE:   'RCA_WORKFLOW_DELETE',
  RCA_WORKFLOW_TOGGLE:   'RCA_WORKFLOW_TOGGLE',
  RCA_WORKFLOW_DUPLICATE:'RCA_WORKFLOW_DUPLICATE',
  // Guardrails
