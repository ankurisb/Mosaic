...
// Shared visual tokens. Kept tight on purpose -- chart styling lives here,
// not in Claude's hands. Claude picks the type and provides the data;
// everything visual is decided by the renderer.
