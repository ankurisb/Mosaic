...
const productionOrders = [
  { ManufacturingOrder: '000010001234', Plant: '1000', MaterialNumber: 'SKU-A100', TotalQuantity: '500.000', ProductionUnit: 'EA', SystemStatus: 'REL', MfgOrderActualStartDate: '/Date(1708992000000)/', MfgOrderPlannedEndDate: '/Date(1709856000000)/', ProductionVersion: '0001' },
  { ManufacturingOrder: '000010001235', Plant: '1000', MaterialNumber: 'SKU-A200', TotalQuantity: '300.000', ProductionUnit: 'EA', SystemStatus: 'REL', MfgOrderActualStartDate: '/Date(1709078400000)/', MfgOrderPlannedEndDate: '/Date(1709942400000)/', ProductionVersion: '0001' },
  { ManufacturingOrder: '000010001236', Plant: '1000', MaterialNumber: 'SKU-B300', TotalQuantity: '150.000', ProductionUnit: 'EA', SystemStatus: 'TECO', MfgOrderActualStartDate: '/Date(1709164800000)/', MfgOrderPlannedEndDate: '/Date(1709769600000)/', ProductionVersion: '0002' },
  { ManufacturingOrder: '000010001237', Plant: '1000', MaterialNumber: 'SKU-B400', TotalQuantity: '200.000', ProductionUnit: 'EA', SystemStatus: 'REL', MfgOrderActualStartDate: '/Date(1709251200000)/', MfgOrderPlannedEndDate: '/Date(1710115200000)/', ProductionVersion: '0001' },
  { ManufacturingOrder: '000010001238', Plant: '2000', MaterialNumber: 'SKU-C500', TotalQuantity: '400.000', ProductionUnit: 'EA', SystemStatus: 'CRTD', MfgOrderActualStartDate: null, MfgOrderPlannedEndDate: '/Date(1710201600000)/', ProductionVersion: '0001' },
  { ManufacturingOrder: '000010001239', Plant: '1000', MaterialNumber: 'SKU-C600', TotalQuantity: '250.000', ProductionUnit: 'EA', SystemStatus: 'REL', MfgOrderActualStartDate: '/Date(1709424000000)/', MfgOrderPlannedEndDate: '/Date(1710288000000)/', ProductionVersion: '0001' },
  { ManufacturingOrder: '000010001240', Plant: '1000', MaterialNumber: 'SKU-A100', TotalQuantity: '600.000', ProductionUnit: 'EA', SystemStatus: 'DLV', MfgOrderActualStartDate: '/Date(1709510400000)/', MfgOrderPlannedEndDate: '/Date(1710115200000)/', ProductionVersion: '0001' },
  { ManufacturingOrder: '000010001241', Plant: '1000', MaterialNumber: 'SKU-B300', TotalQuantity: '100.000', ProductionUnit: 'EA', SystemStatus: 'REL', MfgOrderActualStartDate: '/Date(1709596800000)/', MfgOrderPlannedEndDate: '/Date(1710460800000)/', ProductionVersion: '0002' },
];
...
const maintenanceNotifications = [
  ...
  { MaintenanceNotification: '100000501', NotificationType: 'M1', NotificationText: 'Hydraulic leak - seal failure',          MaintPriorityCode: '1', TechnicalObject: '10000006', CreationDate: '/Date(1728950400000)/', MalfunctionStartDate: '/Date(1728950400000)/', IsCompleted: true,  NotificationStatus: 'NOCO' },
  { MaintenanceNotification: '100000502', NotificationType: 'M2', NotificationText: 'Dimensional drift on CNC-03',            MaintPriorityCode: '2', TechnicalObject: '10000003', CreationDate: '/Date(1729555200000)/', MalfunctionStartDate: '/Date(1729555200000)/', IsCompleted: true,  NotificationStatus: 'NOCO' },
  { MaintenanceNotification: '100000503', NotificationType: 'M1', NotificationText: 'Pressure loss',                          MaintPriorityCode: '1', TechnicalObject: '10000006', CreationDate: '/Date(1731024000000)/', MalfunctionStartDate: '/Date(1731024000000)/', IsCompleted: true,  NotificationStatus: 'NOCO' },
  { MaintenanceNotification: '100000504', NotificationType: 'M2', NotificationText: 'Control system fault',                   MaintPriorityCode: '2', TechnicalObject: '10000006', CreationDate: '/Date(1733227200000)/', MalfunctionStartDate: '/Date(1733227200000)/', IsCompleted: true,  NotificationStatus: 'NOCO' },
