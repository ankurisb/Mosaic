          ...
          {ssoProviders.length > 0 && (
            <>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {ssoProviders.map(p => {
                  const label = p.provider === 'microsoft'
                    ? 'Microsoft'
                    : p.provider === 'google'
                      ? 'Google'
                      : 'Single Sign-On'
                  ...
                  const logo = p.provider === 'microsoft'
                    ...
                    : p.provider === 'google'
                      ...
                      : <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M8 1.5 L11.5 3.5 L11.5 7.5 C11.5 10.5 8 13.5 8 13.5 C8 13.5 4.5 10.5 4.5 7.5 L4.5 3.5 Z"/><circle cx="8" cy="7" r="1.5" fill="currentColor" stroke="none"/></svg>
                  return (
